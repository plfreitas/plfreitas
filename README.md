...
### 🚀 Desenvolvedor Full Stack | IA Agêntica & Automação | Analista de Dados

> **Foco:** Arquitetura de Software Web, Agentes de IA (n8n/LangChain), Engenharia de Dados & Sistemas Operacionais Corporativos.
>
...
### 💻 Desenvolvimento Full Stack & Desktop
...
### 🛡️⚡ TI Central Hub — Volumetria & BI Operacional
* **SLA de 24h & Monitoramento:** Dashboard corporativo e app Desktop (.exe nativo via Tauri) para monitoramento em tempo real de chamados da equipe de tecnologia.
* **Segurança Client-Side:** Sistema de defesa contra Brute-Force (`RateLimiter.js`) persistido e limite anti-spam por dispositivo.
